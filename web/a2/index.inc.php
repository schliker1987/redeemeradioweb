...
<head>
    ...
    <title>AnonyProxies - <?php echo $GLOBALS['_config']['script_title']; ?> - Free web proxy, Free Anonymous VPN, Free anonymous surfing, IP protection, Secret surfing, AnonySurf, Protect your internet freedoms!</title>
...
<body onload="" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2"> 
                        ...
                        <h1 class="brand-heading" style='margin-top:0;'>AnonyProxies</h1>
                        
                        <?php 
                        	if (!$data['category'] || $data['category'] == null) { 
                        ?>
                        		<p>Welcome to the A2 free web proxy powered by AnonyProxies!</p>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; AnonyProxies.com! <a href='privacy.html'>Privacy policy</a>.</p>
        </div>
    </footer>
